...
Permissions for viewing the UCP module and the ACP module can be set. Founders will be able to see the ACP panel anyway.',*/
	...
	// Umil 
	'INSTALL_AFKMANAGER'			=>	'Install AFK Manager',
	'INSTALL_AFKMANAGER_CONFIRM'	=>	'Do you wish to install AFK Manager?',
	'UPDATE_AFKMANAGER'				=>	'Update AFK Manager',
	'UPDATE_AFKMANAGER_CONFIRM'		=>	'Do you wish to update AFK Manager?',
	'UNINSTALL_AFKMANAGER'			=>	'Uninstall AFK Manager',
	'UNINSTALL_AFKMANAGER_CONFIRM'	=>	'Do you wish to uninstall AFK Manager?',	
