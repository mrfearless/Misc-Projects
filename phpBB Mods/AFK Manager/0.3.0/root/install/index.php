...
{
	set_config('afkmanager_afk_posting_enable', 1);
	set_config('afkmanager_afk_posting_forumid', 0);
	set_config('afkmanager_afk_posting_reply', 1);
	set_config('afkmanager_afk_posting_topicicon', 0);
	set_config('afkmanager_afk_show_status_viewtopic', 1);
	set_config('afkmanager_afk_show_status_viewprofile', 1);
	set_config('afkmanager_afk_show_reminder_board', 1);
	set_config('afkmanager_afk_posting_footer', '<br /><hr /><br />This Auto Post was made by AFK Manager v0.3.0 -[Nwo]- fearless 2009.<br />');
}
?>