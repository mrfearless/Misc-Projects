...
$notify_email =  "donations@newworldorder.org.uk";         //email address to which debug emails are sent to
$DB_Server = "localhost"; //your MySQL Server
$DB_Username = "newworld_paypal"; //your MySQL User Name
$DB_Password = "cocaine"; //your MySQL Password
$DB_DBName = "newworld_paypal"; //your MySQL Database Name
