...
// versions array
	$versions = array(
		...
		// v 1.1.0 - Added Banner Images Module
		'1.1.0' => array(
			// Now to add some permission settings
			'permission_add' => array(
				array('a_nwo_bannerimages', true),
			),
			...
			'module_add' => array(
				array('acp', 'ACP_NWOMANAGER', array(
            		'module_basename'   => 'nwomanager',
            		'module_langname'   => 'ACP_NWOMANAGER_BANNERIMAGES',
            		'module_mode'       => 'nwobannerimages',
            		'module_auth'       => 'acl_a_nwo_bannerimages',
       			)),
       		),

			// Add config settings
			'config_add' => array(
				array('nwomanager_bannerimages_folder', ''),
				array('nwomanager_bannerimages_enabled', '1'),
				array('nwomanager_bannerimages_height', '350'),
				array('nwomanager_bannerimages_width', '500'),
				array('nwomanager_bannerimages_delay', '5000'),
				array('nwomanager_bannerimages_fade', '500'),
				array('nwomanager_bannerimages_reveal', '1'),
			),

  			// Add tables, primary keys and other indexes
			'table_add' => array(
				// Banner Images Table
				array(NWOBANNERIMAGES_TABLE, array(
					'COLUMNS'					=> array(
						'banner_id' 			=> array('INT:8', NULL, 'auto_increment'),
						'banner_name'			=> array('VCHAR_UNI:60', ''),
						'banner_image'			=> array('VCHAR_UNI:255', ''),
						'banner_linktarget'		=> array('VCHAR_UNI:255', ''),
						'banner_description'	=> array('VCHAR_UNI:255', ''),
						'banner_order'			=> array('INT:8', NULL),
						'banner_visible'		=> array('TINT:1', 0),
						'banner_type'			=> array('TINT:3', 0),
 					),
					'PRIMARY_KEY'				=> 'banner_id',
						'KEYS'					=> array(
							'banner_order'		=> array('INDEX', 'banner_order'),
						),
					),
				),
       		),
		...
		// v 1.1.1 - Added Banner Images Module
		'1.1.1' => array(

		// Add config settings
			'config_add' => array(
				array('nwomanager_donations_target', '150'),
				array('nwomanager_donations_cycle', '6'),
			),
		...
		// v 1.1.2 - Added Donations Module
		'1.1.2' => array(
			// Now to add some permission settings
			'permission_add' => array(
				array('a_nwo_donations', true),
			),
			...
			'module_add' => array(
				array('acp', 'ACP_NWOMANAGER', array(
            		'module_basename'   => 'nwomanager',
            		'module_langname'   => 'ACP_NWOMANAGER_DONATIONS',
            		'module_mode'       => 'nwodonations',
            		'module_auth'       => 'acl_a_nwo_donations',
       			)),
       		),
