	...
	function main($id, $mode)
	{
		...
		switch($mode)
		{
			...
			case 'nwodonations':
				...
				{
					// to do later possibly, for now read only view of database is all thats required
				}
				else
				{
					...
					//while($row = $db->sql_fetchrow($result))
					{
						...
						$template->assign_block_vars('donations', array(
							'DONOR_NAME'			=> !empty($donoruser) ? $donoruser : proper(trim($row['firstname'])) . ' ' . proper(trim($row['lastname'])),
